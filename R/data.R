...
#
# A dataset containing two matrices of vectorized correlation matrices, with original dimension of 86x86,
# of 23 control subjects and 14 TGA-diagnosed patients.
#
# @format A list of 2 matrices with 3,655 columns:
# \describe{
#   \item{control}{control subjects with n (rows) = 23}
#   \item{diagnosed}{diagnosed subjects with n (rows) = 14}
# }
