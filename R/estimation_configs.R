...
#'
#' A list of default configurations for \link[corrfuncs]{estimate_model}. running the function will print the defaults.
...
#' - matrix_reg: parameters passed on to \link[corrfuncs]{regularize_matrix}. the weighting matrix (covariance matrix of correlations) is regularized accordingly
